...
const siteConfig = {
  ...
  url: 'https://factly.github.io', // Your website URL
  baseUrl: '/dega-docs/', // Base URL for your project */
  // For github.io type URLs, you would set the url and baseUrl like:
  //   url: 'https://facebook.github.io',
  //   baseUrl: '/test-site/',

  // Used for publishing and more
  projectName: 'dega-docs',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Factly`,
